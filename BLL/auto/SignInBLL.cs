...
public partial class SignInBLL{
/// <summary>
/// 数据库操作对象
/// </summary>
private SignInDAO _dao = new SignInDAO();
...
public IEnumerable<SignIn> QueryList(int index, int size=10, object wheres=null, string orderField=null, bool isDesc=false)
{
...
#endregion
#region 查询单个模型实体 +SignIn QuerySingleByWheres(object wheres)
///<summary>
///查询单个模型实体
///</summary>
///<param name="wheres">条件匿名类</param>
