...
{
    public partial class FavoriteItemBLL
    {
        /// <summary>
        /// 数据库操作对象
        /// </summary>
        private FavoriteItemDAO _dao = new FavoriteItemDAO();
        ...
        public IEnumerable<FavoriteItem> QueryList(int index, int size = 10, object wheres = null, string orderField = null, bool isDesc = false)
        {
        ...
        #endregion
        #region 查询单个模型实体 +FavoriteItem QuerySingleByWheres(object wheres)
        ///<summary>
        ///查询单个模型实体
        ///</summary>
        ///<param name="wheres">条件匿名类</param>
        ...
        {
            return _dao.QuerySingleById(uuid);
        }
        #endregion
        #region 查询单个模型实体 +Dictionary<string,object> QuerySingleByIdX(long uuid,object columns)///<summary>
        ///查询单个模型实体
        ///</summary>
        ///<param name=uuid>key</param>
        ///<returns>实体</returns>
        ...
        {
            return _dao.QuerySingleByIdX(uuid, columns);
        }
        #endregion
        ...
        {
            return _dao.UpdateById(uuid, columns);
        }
        #endregion
