...
namespace MvcApplication1.BLL
{
    public partial class FavoriteBLL
    {
        ...
        #endregion
        #region 删除一条记录 +bool Delete(long favorites_id)
        /// <summary>
        /// 删除一条记录
        /// </summary>
        ...
        #endregion
        #region 查询单个模型实体 +Favorite QuerySingleByWheres(object wheres)
        ///<summary>
        ///查询单个模型实体
        ///</summary>
        ///<param name="wheres">条件匿名类</param>
        ...
        #endregion
        #region 查询单个模型实体 +Dictionary<string,object> QuerySingleByIdX(long favorites_id,object columns)///<summary>
        ///查询单个模型实体
        ///</summary>
        ///<param name=favorites_id>key</param>
        ///<returns>实体</returns>
