...
{
    public class AdvertisingsController : baseApiController
    {
        AdvertisingBLL bll = new AdvertisingBLL();
        public IHttpActionResult GetAdvertisings(string v1, int limit = 10, int page = 0, string where = null, string include = null, string order = null)
        {
            try
            {
