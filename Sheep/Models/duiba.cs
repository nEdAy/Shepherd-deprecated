...
namespace Sheep.Models
{
    public class duiba
    {
         ...
         */
        public static Hashtable GetUrlParams(string requestUri)
        {
            Hashtable param = new Hashtable();
            string[] urlInfo = requestUri.Split('?');
            if (urlInfo.Length > 1)
            {
        ...
        * @return
        */
        public static bool SignVerify(string appSecret, Hashtable hshTable, out string newSign)
        {
