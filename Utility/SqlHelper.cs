...
namespace MvcApplication1.Utility
{
    ...
    public static partial class SqlHelper
    {
        ...
        /// <returns>生成的T-SQL语句</returns>
        public static string GenerateUpdateSql(string table, string set, string where)
        {
            where = string.IsNullOrEmpty(where) ? string.Empty : "where " + where;
            const string format = "update {0} set {1} {2}";
            return string.Format(format, table, set, where);
        }
        #endregion
        ...
        public static int ExcuteCounter(string cmdText, params SqlParameter[] parameters)
        {
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                using (SqlCommand cmd = new SqlCommand(cmdText, conn))
        ...
        public static int ExecuteNonQuerysTransaction(string cmdText, SqlParameter[] parameters, string cmdText1, SqlParameter[] parameters1, string cmdText2, params SqlParameter[] parameters2)
        {
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                conn.Open();
        ...
        public static int ExecuteNonQuerysTransaction(string cmdText, SqlParameter[] parameters, string cmdText1, SqlParameter[] parameters1, string cmdText2, SqlParameter[] parameters2, string cmdText3, params SqlParameter[] parameters3)
        {
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                conn.Open();
        ...
        public static int ExecuteNonQuerysTransaction(string cmdText, SqlParameter[] parameters, string cmdText1, SqlParameter[] parameters1, string cmdText2, SqlParameter[] parameters2, string cmdText3, SqlParameter[] parameters3,string cmdText4, params SqlParameter[] parameters4)
        {
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                conn.Open();
        ...
        public static int ExecuteNonQuerysTransaction(string cmdText, SqlParameter[] parameters, string cmdText1, SqlParameter[] parameters1, string cmdText2, SqlParameter[] parameters2, string cmdText3, SqlParameter[] parameters3, string cmdText4, SqlParameter[] parameters4, string cmdText5, params SqlParameter[] parameters5)
        {
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                conn.Open();
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    try
                    {
                        ...
                        cmd.Parameters.Clear();
                        cmd.Parameters.AddRange(parameters5);
        ...
        public static string parseWheresForDynamicLINQ(this object wheres, out object[] paramsArray, out string like, out string likeWho)
        {
            string returnValue = "";
            ...
            if (wheres == null) return returnValue;
            //多条件
            List<Wheres> whereList = (List<Wheres>)wheres;
            int i = 0;
            foreach (Wheres whs in whereList)
            {
                if (whs.operation.ToString() == "LIKE")
                {
                    like = whs.key;
                    likeWho = whs.value.ToString();
                }
                else
                {
                    if (String.IsNullOrEmpty(whs.relation.ToString()))
                        returnValue += string.Format(" {0} {1} @{2} ", whs.key, whs.operation, i);
                    else
                        returnValue += string.Format(" {0} {1} {2} @{3} ", whs.relation, whs.key, whs.operation, i);
                    li.Add(whs.value);
                    i++;
                }
            }

            paramsArray = li.ToArray();
